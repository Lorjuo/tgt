module Linkable
  class MediaLinksController < BaseController
    ...
    private
      ...
      def resource_params
        params.require(:media_link).permit(:controller_id, :instance_id, :link_attributes => [:id, :name, :active, :parent_id, :theme_id, :department_id]) # Missing id column in permit statement can cause deadloops!!!
      end
